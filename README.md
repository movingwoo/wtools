...
OpenPGP, GIF, Brotli·Zstandard·Bzip2·LZ4의 동적 ESM/WASM은 하위 import까지 검토한 로컬 사본을 사용합니다. crypto-js만 페이지를 열 때 불러오며, YAML·TOML·JSONPath·JMESPath는 자체 엔진을 필요한 순간에 불러옵니다.
